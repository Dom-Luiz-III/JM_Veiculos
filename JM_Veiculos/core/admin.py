...
from .models import Carro, Moto, Utilitarios


class CarroAdmin(admin.ModelAdmin):
    list_display = ('modelo', 'marca', 'ano_fabricacao', 'estado', 'km_rodados', 'leilao', 'formas_pagamento', 'situacao' , 'placa' , 'display_foto')
